...
('Зоряна крапля', 5000, 'Артефакти', '/static/images/shop/Stardrop.png'),
('Блакитна курка', 2000, 'Тварини', '/static/images/shop/Blue_Chicken.png'),
('Меч Галактики', 1500, 'Зброя', '/static/images/shop/Galaxy_Sword.png'),
('Золотий Гарбуз', 300, 'Насіння', '/static/images/shop/Pumpkin.png');
